...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-20 right-10 w-96 h-96 bg-teal-500 rounded-full filter blur-3xl opacity-5 z-0"></div>
      <div className="absolute bottom-20 left-20 w-80 h-80 bg-indigo-500 rounded-full filter blur-3xl opacity-5 z-0"></div>
        ...
        >
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm p-10 rounded-2xl border border-gray-700/50 shadow-2xl">
            ...
            <p className="text-gray-400 text-center mb-8">
              Partagez votre histoire inspirante avec le monde
            </p>
            ...
            <div className="mt-10 pt-6 border-t border-gray-700/50 text-center">
              <p className="text-gray-400 text-sm">
                ...
                <a href="#" className="text-teal-400 hover:text-teal-300 hover:underline">
